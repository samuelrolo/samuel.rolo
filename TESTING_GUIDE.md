...
curl -X POST https://share2inspire-backend.lm.r.appspot.com/api/services/kickstart-confirm \
  -H "Content-Type: application/json" \
  -d '{"name":"Test","email":"test@example.com","phone":"912345678"}'

# 2. Testar endpoint Ifthenpay
curl https://share2inspire-backend.lm.r.appspot.com/api/payment/health
