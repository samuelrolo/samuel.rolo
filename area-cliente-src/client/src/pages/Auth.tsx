    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-20 bg-[#FAFAF9]">
        <div className="w-full max-w-sm">
          ...
          {/* Google Sign-In Button (visible on login and register modes) */}
          {mode !== 'reset' && (
            <>
              <button
                type="button"
                ...
                className="w-full py-2.5 bg-white border border-[#ddd] rounded text-sm text-[#1a1a1a] font-medium hover:bg-[#f5f5f4] hover:border-[#bbb] disabled:opacity-50 transition-all duration-300 flex items-center justify-center gap-3 mb-5"
              >
                {googleLoading ? (
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="text-xs text-[#999] font-light">{t('auth.or')}</span>
                <div className="flex-1 h-px bg-[#ddd]" />
              </div>
            </>
          )}
