  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
        <span className="text-sm font-semibold text-card-foreground sm:w-44 sm:shrink-0">{label}</span>
        <div className="flex items-center gap-2 sm:gap-3 flex-1">
          ...
          <span className="text-sm font-bold text-card-foreground w-10 text-right shrink-0">{score}</span>
        </div>
      </div>
      {insight && (
