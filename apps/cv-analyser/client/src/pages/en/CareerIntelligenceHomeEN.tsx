    ...
    try {
      ...
      const response = await fetch(`${BACKEND_URL}/api/payment/stripe-checkout`, {
        ...
        body: JSON.stringify({
          ...
          success_url: `${window.location.origin}/en/career-intelligence/results?payment=success&session_id={CHECKOUT_SESSION_ID}`,
          cancel_url: `${window.location.origin}/en/career-intelligence`,
        })
      });
      const data = await response.json();
            ...
            <div className="bg-card border border-border rounded-2xl p-8 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  ...
                  <input type="url" placeholder="https://linkedin.com/in/your-profile" value={linkedinUrl} onChange={(e) => setLinkedinUrl(e.target.value)} disabled={loading} className="w-full pl-11 pr-4 py-3 rounded-xl border border-border bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-[#C9A961]/30 focus:border-[#C9A961] transition-colors text-sm" />
                </div>
