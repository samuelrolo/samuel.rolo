    ...
    try {
      ...
      const response = await fetch(`${BACKEND_URL}/api/payment/stripe-checkout`, {
        ...
        body: JSON.stringify({
          ...
          success_url: `${window.location.origin}/en/career-path/results?payment=success&session_id={CHECKOUT_SESSION_ID}`,
          cancel_url: `${window.location.origin}/en/career-path`,
        })
      });
        ...
        {step === 'hero' && (
          <div className="space-y-12 animate-in fade-in">
            ...
            <div className="rounded-2xl border border-[#C9A961]/20 bg-gradient-to-b from-[#C9A961]/5 to-transparent overflow-hidden">
              <div className="p-6 md:p-8 space-y-4">
                ...
                <p className="text-center text-sm md:text-base font-medium italic" style={{ color: '#C9A961' }}>
                  What career consultants charge €600+ for, Share2Inspire delivers in 30 seconds for {CUR}{PRICE}.
                </p>
              </div>
            </div>
              ...
              <div className="p-6 md:p-8 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2">
                  ...
                  <div className="p-4 rounded-xl bg-white border border-border flex flex-col h-full">
                    ...
                    <p className="text-xs text-muted-foreground mt-2 flex-1">Get your Career Path for {CUR}{PRICE}, then upgrade to Career Intelligence for just {CUR}29.</p>
                  ...
                  <div className="p-4 rounded-xl bg-white border border-purple-200 flex flex-col h-full">
                    ...
                    <p className="text-xs text-muted-foreground mt-2 flex-1">Everything in Career Path + strategic comparison, trade-offs, and final recommendation.</p>
            ...
            <div className="text-center space-y-4 p-8 rounded-2xl bg-[#C9A961]/5 border border-[#C9A961]/20">
              ...
              <p className="text-muted-foreground">Full analysis for {CUR}{PRICE}. One-time payment. No subscription. Results in under 1 minute.{hasMemberDiscount && <span className="ml-1 text-green-600 font-medium">(member discount {memberTier === 'pro' ? 'Pro' : 'Growth'})</span>}</p>
              <Button
                onClick={() => setStep('upload')}
