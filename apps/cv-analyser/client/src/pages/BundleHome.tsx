        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-20">
          ...
          <div className="mt-16 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { icon: <Shield className="w-5 h-5 text-[#C9A961]" />, title: pick("Poupas 22€", "Save €22", "Ahorras 22€"), desc: pick("Por separado custariam 38€. Em bundle, pagas apenas 15,99€.", "Separately they would cost €38. In a bundle, you pay only €15.99.", "Por separado costarían 38€. En bundle, pagas solo 15,99€.") },
