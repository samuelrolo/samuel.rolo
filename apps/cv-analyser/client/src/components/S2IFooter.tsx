/**
 * S2IFooter — Matches the Share2Inspire landing page footer exactly (Bootstrap row g-4 layout).
 * col-lg-4 | col-lg-2 | col-lg-2 | col-lg-2 | col-lg-2
 */
    ...
    <footer style={{ background: '#1A1A1A', color: '#fff', padding: '60px 0 30px', marginTop: 0, width: '100%' }}>
      <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '0 15px' }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '24px 0' }}>
          {/* Logo — col-lg-4 (33.33%) */}
          <div style={{ flex: '0 0 33.33%', maxWidth: '33.33%', paddingRight: '15px', boxSizing: 'border-box' }}>
          ...
          {/* Navegação — col-lg-2 (16.67%) */}
          <div style={{ flex: '0 0 16.67%', maxWidth: '16.67%', paddingRight: '15px', boxSizing: 'border-box' }}>
          ...
          {/* Contacto — col-lg-2 */}
          <div style={{ flex: '0 0 16.67%', maxWidth: '16.67%', boxSizing: 'border-box' }}>
