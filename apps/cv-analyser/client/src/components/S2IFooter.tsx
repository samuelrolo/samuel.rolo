/**
 * S2IFooter — Reusable footer matching the Share2Inspire landing page (4-column layout).
 * Used across all Home / Bundle / CareerPath / CareerIntelligence pages.
 */
export default function S2IFooter() {
  ...
  return (
    <footer style={{ background: '#1A1A1A', color: '#fff', padding: '60px 0 30px', marginTop: 0 }}>
      <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '0 15px' }}>
        {/* 5-column grid: logo | nav | tools | legal | contact */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '32px' }}>
          ...
          <div>
            ...
            <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.82rem', marginBottom: '15px' }}>
              <span style={{ color: '#C9A961', marginRight: '8px' }}>✉</span>
              geral@share2inspire.pt
            </p>
            <div style={{ display: 'flex', gap: '12px' }}>
              <a
                ...
                style={{ color: '#C9A961', fontSize: '1.1rem', transition: 'color .3s' }}
                aria-label="LinkedIn"
              >
                {/* LinkedIn SVG icon */}
              ...
              <a
                href="https://www.instagram.com/share2inspire_/"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: '#C9A961', fontSize: '1.1rem', transition: 'color .3s' }}
