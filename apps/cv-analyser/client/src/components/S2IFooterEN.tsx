/**
 * S2IFooterEN — English version of the reusable footer matching the Share2Inspire landing page.
 */
      ...
      <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '0 15px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '32px' }}>
          ...
          <div>
            ...
            <a href="/sobre" style={linkStyle}>About</a>
            <a href="/servicos" style={linkStyle}>Services</a>
