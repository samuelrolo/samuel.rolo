...
file_path = r'c:\Users\samue\.gemini\antigravity\scratch\samuel.rolo\apps\cv-analyser\client\src\pages\BundleHome.tsx'
...
text = re.sub(extraction_old, extraction_new, text)
...
text = text.replace('sessionStorage.setItem(\'analysisCountry\', selectedCountry || \'Portugal\');', 'sessionStorage.setItem(\'analysisCountry\', currentCountry);')
